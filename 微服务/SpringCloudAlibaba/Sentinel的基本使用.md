...
![img](../../image/68747470733a2f2f63646e2e79757175652e636f6d2f6c61726b2f302f323031382f706e672f35343331392f313533323038343634303133372d38663462633136632d343333362d346331622d396464642d3435383262393637373137612e706e67)
...
1. 访问 http://localhost:8080 页面，可以在左侧看到 Sentinel-Example 应用已经注册到了控制台，单击 **流控规则** ，可以看到目前的流控规则为空。
   ...
   ![img](../../image/68747470733a2f2f63646e2e6e6c61726b2e636f6d2f6c61726b2f302f323031382f706e672f35343331392f313533323331353935313831392d39666664393539652d303534372d346636312d386630362d3931333734636665376632312e706e67)
...
2. 配置 URL 限流规则：点击新增流控规则，资源名填写需要限流的 URL 相对路径，单机阈值选择需要限流的阈值，点击新增进行确认。(为了便于演示效果，这里将值设置成了 1)。
   ...
   ![img](../../image/68747470733a2f2f63646e2e79757175652e636f6d2f6c61726b2f302f323031382f706e672f35343331392f313533323037383731373438332d36326162373463642d653564612d343234312d613435642d3636313636623162646539392e706e67)


3. 配置自定义限流规则：点击新增流控规则，资源名填写 `@SentinelResource` 注解 `value` 字段的值，单机阈值选择需要限流的阈值，点击新增进行确认。(为了便于演示效果，这里将值设置成了 1)。

   ![img](../../image/68747470733a2f2f63646e2e79757175652e636f6d2f6c61726b2f302f323031382f706e672f35343331392f313533323038303635323137382d62653131396334612d326130382d346636372d626537302d6665356564396132343861332e706e67)
...
![img](../../image/68747470733a2f2f63646e2e79757175652e636f6d2f6c61726b2f302f323031382f706e672f35343331392f313533323038343139393232342d31613431353931642d376130362d343638302d626538612d3564653331396163363335642e706e67)

## 查看实时监控
Sentinel 控制台支持实时监控查看，您可以通过 Sentinel 控制台查看各链路的请求的通过数和被限流数等信息。
其中 `p_qps` 为通过(pass) 流控的 QPS，`b_qps` 为被限流 (block) 的 QPS。

![img](../../image/68747470733a2f2f63646e2e6e6c61726b2e636f6d2f6c61726b2f302f323031382f706e672f35343331392f313533323331333539353336392d38343238636437642d396562372d343738362d613134392d6163663064613461326461662e706e67)
